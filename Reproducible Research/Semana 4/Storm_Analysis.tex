...
\KeywordTok{download.file}\NormalTok{(fileUrl, }\DataTypeTok{destfile =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"/home/CIT/vcoluci/Downloads"}\NormalTok{, }\StringTok{'/repdata%2Fdata%2FStormData.csv.bz2'}\NormalTok{))}
\NormalTok{stormDF <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"/home/CIT/vcoluci/Downloads/repdata%2Fdata%2FStormData.csv.bz2"}\NormalTok{)}
